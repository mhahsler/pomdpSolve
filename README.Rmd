...
A convenient interface is provided in package [pomdp](https://michael.hahsler.net/pomdp/). 
...
A detailed description of the available solver options can be found [here](https://michael.hahsler.net/pomdpSolve/pomdp-solve_manual).
